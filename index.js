...
const PRIVATE_APP_ACCESS = 'pat-eu1-a3f973fe-4c44-490f-b053-ae3067760bd6';

// TODO: ROUTE 1 - Create a new app.get route for the homepage to call your custom object data. Pass this data along to the front-end and create a new pug template in the views folder.

app.get("/", async (req, res) => {
    const url = "https://api.hubspot.com/crm/v3/objects/concerts?properties=name,composer,concert_date_time";
    ...
    const params = {
        properties: ["name", "composer", "concert_date_time"],
    };
